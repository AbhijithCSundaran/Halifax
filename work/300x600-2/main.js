...
function animate() {
  ...
  tl.addLabel('frame_2', 4)
    .to(shape, 1.5, { y: 350, ease: "power2.inOut" }, "frame_2")
    .to(copy2, 0.5, { autoAlpha: 1, ease: "power2.inOut" }, "frame_2+=1.5")
    .to(logo, 0.5, { autoAlpha: 1, ease: "power2.inOut" }, "frame_2+=1.5")
    .to(terms, 0.5, { autoAlpha: 1, ease: "power2.inOut" }, "frame_2+=1.5");
  ...
  tl.addLabel('frame_3', 10)
    ...
    .to(shape, 1, { y: 0, ease: "power2.inOut" }, "frame_3")
    .to(copy3, 0.5, { autoAlpha: 1, ease: "power2.inOut" }, "frame_3+=1")
    .to(bgExit, 0.5, { autoAlpha: 1, display: 'block', ease: "power2.inOut" }, "frame_3+=1")
    .to(cta, 0.5, { autoAlpha: 1, ease: "power2.inOut" }, "frame_3+=1");
